...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        className={`${inter.className} bg-black/85 text-white absolute inset-0 -z-10 h-full w-full bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]`}
      >
        {children}
      </body>
    </html>
